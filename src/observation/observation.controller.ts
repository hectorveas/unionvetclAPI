import {
  ...
  export class ObservationController {
    ...
    @Roles(Role.ADMIN)
    @Post()
    async createObservation(@Res() res, @Body() createObservationDTO: CreateObservationDTO) {
      const observation = await this.observationService.createObservation(createObservationDTO);
